...
import api from '../utils/api.js' // FIXED PATH: Added .js extension for resolution
...
      // UPDATED CALL: Use 'api.post' and the relative path '/products'
      await api.post('/products', payload, { headers: { 'x-admin-token': token }})
      
