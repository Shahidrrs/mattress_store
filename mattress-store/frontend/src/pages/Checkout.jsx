...
// Attempting to resolve the path error by changing the file extension to .js
...
export default function Checkout() {
        ...
        const options = {
            ...
            handler: async function (response) {
                ...
                try {
                    ...
                    await axios.post(apiUrl + '/api/orders/confirm-payment', 
                        { 
                            orderId: orderId,
    ...
    const pay = async () => {
        ...
        try {
            ...
            // The customer object now contains the correctly nested address object.
            const orderResponse = await axios.post(apiUrl + '/api/orders/create', 
                { 
                    items: cart, 
                    total, 
            ...
            const paymentResponse = await axios.post(apiUrl + '/api/payments/create-order', 
                { 
                    orderId: orderId, 
                    amount: total, 
